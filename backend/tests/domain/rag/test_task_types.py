from app.domain.rag.task_types import TaskType, Locale, classify_task_type, detect_locale
...
def test_classify_task_type():
    ...
    long_query = "this is a very long query that just goes on and on for more than twelve words total here."

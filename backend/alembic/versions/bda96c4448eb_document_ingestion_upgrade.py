...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column('documents', sa.Column('current_stage', sa.String(length=20), server_default='QUEUED', nullable=False))
    op.add_column('documents', sa.Column('progress_pct', sa.Integer(), server_default='0', nullable=False))
    op.add_column('documents', sa.Column('error_message', sa.Text(), nullable=True))
    op.add_column('documents', sa.Column('processed_chunks', sa.Integer(), server_default='0', nullable=False))
    ...
    op.add_column('documents', sa.Column('upload_source', sa.String(length=30), server_default='SETUP', nullable=False))
    op.add_column('documents', sa.Column('document_sha256', sa.String(length=64), nullable=True))
    op.add_column('documents', sa.Column('normalized_content_hash', sa.String(length=64), nullable=True))
    ...
    op.add_column('documents', sa.Column('retrieval_scope', sa.String(length=30), server_default='GLOBAL', nullable=False))
    op.add_column('documents', sa.Column('scope_id', sa.UUID(), nullable=True))
    op.add_column('documents', sa.Column('storage_key', sa.String(length=500), server_default='', nullable=False))

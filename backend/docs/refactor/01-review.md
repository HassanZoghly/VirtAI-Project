...
## HUMAN VERIFICATION
- [x] One manual smoke test scenario executed and screen-recorded (artifact attached or steps documented) - Domain logic only tested via Pytest.
- [x] Code review checklist file committed: docs/refactor/01-review.md
